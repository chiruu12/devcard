...
class Generator(BaseModel):
    ...
    url: Optional[str] = Field(default=None, description="URL of the generator project")


class Identity(BaseModel):
    username: str = Field(description="GitHub username")
    name: Optional[str] = Field(default=None, description="Display name")
    bio: Optional[str] = Field(default=None, description="GitHub profile bio")
    avatar_url: Optional[str] = Field(default=None, description="URL to avatar image")
    location: Optional[str] = Field(default=None, description="Self-reported location")
    company: Optional[str] = Field(default=None, description="Company or organization")
    blog: Optional[str] = Field(default=None, description="Personal website or blog URL")
    twitter_username: Optional[str] = Field(
        default=None, description="Twitter/X username without @"
    )
    hireable: Optional[bool] = Field(default=None, description="Whether the user is open to hire")
...
class Language(BaseModel):
    ...
    bytes: Optional[int] = Field(default=None, description="Total bytes of code in this language")
...
class Project(BaseModel):
    ...
    status: Optional[Literal["active", "maintained", "inactive", "archived"]] = Field(
        default=None, description="Activity status based on last push date"
    )
    maturity: Optional[Literal["mature", "growing", "new", "stale"]] = Field(
...
class Collaboration(BaseModel):
    ...
    contribution_style: Optional[str] = Field(
        default=None,
